        ...
        $profileData = App\Models\User::find($id);
            ...
            <div class="user-box dropdown px-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i class="bx bx-home-circle fs-5"></i><span>Profile</span></a>

                      <li><a class="dropdown-item d-flex align-items-center" href="javascript:;"><i class="bx bx-home-circle fs-5"></i><span>Setting</span></a>
